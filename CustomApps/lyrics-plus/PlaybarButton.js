(function PlaybarButton() {
	...
	const button = new DT.Playbar.Button(
		"Lyrics Plus",
		...
		() =>
			DT.Platform.History.location.pathname !== "/lyrics-plus"
				? DT.Platform.History.push("/lyrics-plus")
				: DT.Platform.History.goBack(),
		false,
		DT.Platform.History.location.pathname === "/lyrics-plus",
		false
	);
	...
	if (DT.LocalStorage.get("lyrics-plus:visual:playbar-button") === "true") setPlaybarButton();
	...
	DT.Platform.History.listen((location) => {
