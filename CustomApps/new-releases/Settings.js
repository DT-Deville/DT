...
function openConfig() {
	const configContainer = react.createElement(
		...
		react.createElement(OptionList, {
			items: [
				...
				{
					desc: DT.Locale.get("artist.albums"),
					key: "album",
				...
				{
					desc: DT.Locale.get("artist.singles"),
					key: "single-ep",
				...
				/* {
					desc: DT.Locale.get("artist.appears-on"),
					key: "appears-on",
				...
				{
					desc: DT.Locale.get("artist.compilations"),
					key: "compilations",
		...
		react.createElement(
			...
			react.createElement(
				...
				react.createElement(ButtonText, {
					text: DT.Locale.get("equalizer.reset"),
	...
	DT.PopupModal.display({
		title: DT.Locale.get("new_releases"),
