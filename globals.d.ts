declare namespace DT {
	...
	namespace Player {
		...
		const origin: any;
		/**
		 * Register a listener `type` on DT.Player.
		 *
		 * On default, `DT.Player` always dispatch:
		...
		/**
		 * Dispatches an event at `DT.Player`.
		 *
		 * On default, `DT.Player` always dispatch
		 *  - `songchange` type when player changes track.
		 *  - `onplaypause` type when player plays or pauses.
	 ...
	 *
	 * DT.Keyboard is wrapper of this library to be compatible with legacy Spotify,
	...
	namespace ReactComponent {
		type ContextMenuProps = {
			 ...
			 */
			menu:
				| typeof DT.ReactComponent.Menu
				| typeof DT.ReactComponent.AlbumMenu
				| typeof DT.ReactComponent.PodcastShowMenu
				| typeof DT.ReactComponent.ArtistMenu
				| typeof DT.ReactComponent.PlaylistMenu;
			/**
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.ContextMenuProps
		 */
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.MenuProps
		 */
		const Menu: any;
		/**
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.MenuItemProps
		 */
		const MenuItem: any;
		/**
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.TooltipProps
		 */
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.IconComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.TextComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.ConfirmDialogProps
		 */
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.SliderProps
		 */
		const Slider: any;
		/**
		 ...
		 *
		 * Props:
		 * @see DT.ReactComponent.ButtonProps
		 */
	...
	const Tippy: any;
	/**
	 * DT's predefined props for Tippy.js
	...
	/**
	 * DT's QraphQL wrapper for Spotify's GraphQL API endpoints
	 */
	namespace GraphQL {
		/**
		 ...
		 * @description A preinitialized version of `DT.GraphQL.Handler` using current context.
